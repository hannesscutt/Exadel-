namespace ExadelTimeTrackingSystem.BusinessLogic.Validators
{
    ...
    public class TaskDTOValidator : BaseTaskDTOValidator<TaskDTO>
    {
        private readonly ITaskService _taskService;

        public TaskDTOValidator(IUserService userService, IProjectService projectService, ITaskService taskService)
